...
import RainLogo from "../assets/rainfi.png";
...
export function Borrow() {
  ...
  const [fraktNfts, setFraktNfts] = React.useState([]);
      ...
      <div className="w-full">
        ...
        <div className="flex justify-around mx-auto w-full">
          {sharkyOffers?.length > 0 && (
            ...
            >
              <img className="w-8" src={sharkylogo} />
            </OfferDetailsBox>
          )}
          ...
          {rainPoolsWithCollection?.length > 0 && (
            ...
            >
              <img className={"w-auto h-8"} src={RainLogo} />
            </OfferDetailsBox>
          )}
