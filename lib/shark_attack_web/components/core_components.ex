defmodule SharkAttackWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SharkAttackWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SharkAttackWeb.Gettext, "errors", msg, opts)
    end
  end
