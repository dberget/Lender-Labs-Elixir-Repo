defmodule SharkAttack.DiscordConsumer do
  ...
  def send_to_webhook(
    ...
    Api.execute_webhook(
      "1131598768979050648",
      "R-GcoJscGeeGxZdd1KrfuyMysQuYG_9DlqJd0zkMViQRddsJ6s85a9cdSwhPvqS2A3qB",
      %{embeds: [embed]}
    )
  end
  ...
  def send_to_webhook(
    ...
    Api.execute_webhook(
      "1164542294888824882",
      "A89e0MB3QJpYkLyFQm6Qugo9HDuXGECa-QtReXssowvxViaT8n87DXb1Yye3CDdEp8uB",
      %{embeds: [embed]}
    )
  end
  ...
  def send_to_webhook(
    ...
    Api.execute_webhook(
      "1155848439834357853",
      "k-wCijkY7O4qRdBzXMCFJDgXPXIyfm2h6IRUq0ZBWvOosgIOZND0W3gJEuHI5j0WJ6Ye",
      %{embeds: [embed]}
    )
  end
  ...
  def send_to_webhook(
    ...
    Api.execute_webhook(
      "1154440537458356244",
      "oyngAyURdB_mvuPwudSg3p9FlGpquQMCDDBj6gaQCBk8JkCQcIYCStjG2ZNHYJ6Ov8Wy",
      %{embeds: [embed]}
    )
  end
